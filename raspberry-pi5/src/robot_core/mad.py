...
imu.loadCalibDataFromFile("/home/pi/calib_real1.json")
...
while True:
	...
	if print_count == 2:
		print ("mad roll: {0} ; mad pitch : {1} ; mad yaw : {2}".format(int(sensorfusion.roll), int(sensorfusion.pitch), int(sensorfusion.yaw)))
		print_count = 0
